...
def cargarModelo():
    ...
    FILENAME_LABELENCODER_X2_TO_LOAD = "lab_enc_ec.save"
    FILENAME_LABELENCODER_X3_TO_LOAD = "lab_enc_mr.save"
    FILENAME_LABELENCODER_X4_TO_LOAD = "lab_enc_ne.save"
    FILENAME_LABELENCODER_X5_TO_LOAD = "lab_enc_ns.save"
    FILENAME_LABELENCODER_X6_TO_LOAD = "lab_enc_tv.save"
    FILENAME_LABELENCODER_X7_TO_LOAD = "lab_enc_vs.save"
